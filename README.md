...
This application is designed to be deployed to **Google Cloud Run** using Docker.
For detailed deployment instructions (including Cloud SQL bindings and Artifact Registry), see: **`docs/deployment.md`**.
